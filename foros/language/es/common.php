...
$lang = array_merge($lang, array(
	...
	'AVATAR_PHP_SIZE_OVERRUN'			=> 'El tamaño del avatar es muy grande. El tamaño máximo de subida es %1$d %2$s.<br />Por favor observe que esto está definido en php.ini y no puede ser cambiado.',
 	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> 'El avatar especificado no se ha podido cargar porque se agoto el tiempo de espera de la solicitud.',
	...
	'MODERATORS'	=> 'Moderadores',
 	...
 	'MODULE_FILE_INCORRECT_CLASS'	=> 'Archivo de módulo %s no contiene la clase correcta [%s]',
	'MONTH'	=> 'Mes',
	'MOVE'	=> 'Mover',
	'MSNM'	=> 'MSNM/WLM',
	...
	'UNABLE_GET_IMAGE_SIZE'	=> 'El acceso a la imagen no es posible o el archivo no es una imagen válida. Por favor, compruebe que la URL que ha introducido es correcta.',
