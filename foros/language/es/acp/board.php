...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'		=> 'Esto hará al Sitio inaccesible a los usuarios que no son Administradores ni Moderadores. Si quiere, también puede introducir un breve mensaje (255 caracteres) para mostrar.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Ruta en su directorio raíz para imágenes precargadas, ej. <samp>images/avatars/gallery</samp>',
	'AVATAR_STORAGE_PATH'		=> 'Ruta en la que se guardarán los avatares',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Ruta en su directorio raíz, ej. <samp>images/avatars/upload</samp><br />La subida de Avatar <strong>no estará disponible</strong> si no se puede escribir en esa ruta.',
